...
signal1 = ['C:\P5Project\Adobe Audition\19NovAfterTheMeeting\19NovAfterTheMeeting_Recorded\Left_Both_80_deg.wav'];
[a,Freq1] = audioread(signal1);
w = (1:length(a)) / Freq1;

signal2 = ['C:\P5Project\Adobe Audition\19NovAfterTheMeeting\19NovAfterTheMeeting_Recorded\Right_Both_80_deg.wav'];
...
bShifted = zeros(size(b));
 if delay(1) >0
   bShifted(delay(1)+1:end) = b(1:end-delay(1));
 elseif delay(1) <0
   bShifted(1:end+delay(1)) = b(-delay(1)+1:end);
 end
