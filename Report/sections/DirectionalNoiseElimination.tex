...
visual example will be discussed, aimed at better describing the procedure. \todo{mention sampling frequency}
...
managed to make it work in one case is interesting. \todo{I don't know if we should write all this, sounds like we were just doing whatever without thinking about it too much, which was the case, but still, somehow we got something} \\
...
three sound sources. \todo{might need to remove it all or retype it}
