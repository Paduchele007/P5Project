...
As we can see in figure \todo{add here nr} if the sampling rate is too small, the signal will 
...
As we can see in figure \todo{add nr for picture} besides being able to differentiate between 
...
is approximately equal to 100 mels.\todo{add reference}
