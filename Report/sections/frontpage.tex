...
\vspace*{\fill}
  ...
  {\color{white}\fboxsep0pt\colorbox{aaublue}{\begin{tabular}{@{}p{\textwidth}@{}}
    \begin{center}
    \Huge{\textbf{
      A study on the Dik Universe% insert your title here
    }}
    \end{center}
    \begin{center}
      \Large{
        Development of a bigger dik% insert your subtitle here
      }
    \end{center}
    \vspace{0.2cm}
   \begin{center}
...
Paulius Riauka% insert names separated by comma
    ...
    \vspace{0.2cm}
    {\large
      Electronics and Computer Engineering, TEPE4-1005fuk, 2018-08% insert name of study, group number, year-month
    }
   \end{center}
   \vspace{0.2cm}
