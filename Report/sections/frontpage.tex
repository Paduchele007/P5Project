...
\vspace*{\fill}
  ...
  {\color{white}\fboxsep0pt\colorbox{aaublue}{\begin{tabular}{@{}p{\textwidth}@{}}
    \begin{center}
    \Huge{\textbf{
      A study of sound filtering% insert your title here
    }}
    \end{center}
    \begin{center}
      \Large{
        Development of a filtering system% insert your subtitle here
      }
    \end{center}
    \vspace{0.2cm}
   \begin{center}
    {\Large
      Darius Chira,Razvan Bucur,Titas Lasickas,
Paulius Riauka% insert names separated by comma
    }\\
    \vspace{0.2cm}
    {\large
      Electronics and Computer Engineering, ED5-1-F18, 2018-12% insert name of study, group number, year-month
    }
   \end{center}
   \vspace{0.2cm}
