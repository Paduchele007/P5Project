...
increasing rate with age which grows to almost 50\% for persons aged 75 and older is hearing loss.\cite{HEARINGAIDSTUFF2}
...
have never used one.\cite{HEARINGAIDSTUFF} This is partially because of the stigma that comes from using a hearing apparatus.
\cite{WHO}
